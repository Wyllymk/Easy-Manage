...
if ($_POST['action'] === 'delete_post' && isset($_POST['post_id'])) {
    // Set up cURL to call the REST API endpoint for deleting posts
    $post_id = $_POST['post_id'];
    $url = 'https://easy-manage.com/wp-json/contact/v1/api' . $post_id;
    $curl = curl_init();
         ...
         <div class="card">
            <div class="card-header d-flex justify-content-between">
               <div class="header-title">
                  <h4 class="card-title">Messages submitted by Users</h4>
               </div>
            </div>
            <div class="card-body">
               <div class="table-responsive">
                  ...
                  <?php echo do_shortcode( '[externalApi]' );?>
               </div>
