...
if ( $_SERVER["REQUEST_METHOD"] == "POST" && isset( $_POST['submit_project'] ) ) {
    ...
    if ($query->have_posts()) {
     ...
     if ($registration_status !== 'active') {
         wp_die('Error: '. $username. ' does not have an active registration status.');
     }
    // Create post data
    $post_data = array(
...
if (isset($_POST['delete_project'])) {
    ...
    $alert_type = "danger";
    $alert_message = 'Project deleted successfully.';
}
?>
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between breadcrumb-content">
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between">
                                <div class="dropdown status-dropdown mr-3">
                                    ...
                                    <div class="btn bg-body"><span class="h6">Status :</span> Pending<i class="ri-arrow-down-s-line ml-2 mr-0"></i></div>
                                    </div>
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton03">
                                        <a class="dropdown-item" href="<?php echo esc_url(site_url('/projects-in-progress/')); ?>"><i class="ri-attachment-line mr-2"></i>In Progress</a>
                        ...
                        <table id="datatable" class="table data-table table-striped">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td><span class="badge text-bg-danger"><?php echo esc_attr($project_status);?></span> </td>
                                 ...
                                 <td>
                                    <div class="mt-2 d-flex gap-1" >
                                        ...
                                        <form action="" method="post">
                                            ...
                                            <button class="btn btn-primary"type="submit" name="delete_project">Del</button>
                                        </form>
                                    </div>     
                                 </td>
                              </tr>
