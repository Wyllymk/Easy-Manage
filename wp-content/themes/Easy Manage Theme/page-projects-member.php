                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between">
                                <div class="dropdown status-dropdown mr-3">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton03">
                                        <a class="dropdown-item" href="#"><i class="ri-mic-line mr-2"></i>Pending</a>
                                        <a class="dropdown-item" href="#"><i class="ri-attachment-line mr-2"></i>In Progress</a>
                                        <a class="dropdown-item" href="#"><i class="ri-file-copy-line mr-2"></i>Completed</a> 
                                    </div>
                                </div>
