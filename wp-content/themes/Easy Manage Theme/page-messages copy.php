...
if (isset($_POST['delete_message'])) {
    $message_id = $wpdb->prepare('%d', $_POST['message_id']);
    global $wpdb;
    $wpdb->delete('wp_contact', array('contact_id' => $message_id));
  }
?>
    <!-- Wrapper Start -->
    <div class="wrapper">
               ...
               <div class="table-responsive">
                  ...
                  <table id="user-list-table" class="table table-striped dataTable mt-4" role="grid"
                     ...
                     <tbody>
                        <?php
                            global $wpdb;
                            $table_name = $wpdb->prefix . 'contact'; // Replace 'contact' with your actual table name
                            
                            $results = $wpdb->get_results("SELECT * FROM $table_name ORDER BY contact_id DESC");
                            ...
                            <td>
                              <div class="flex align-items-center list-user-action">
                                <form action="" method="post">
                                    <input type="hidden" name="message_id" value="<?php echo $row->contact_id; ?>">
                                    <button class="btn btn-danger"type="submit" name="delete_message">Delete</button>
                                </form>
                              </div>
                            </td>
                        </tr>
